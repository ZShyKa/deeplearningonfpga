...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.myproject.autotvout_layer11_out_0.dat"
         "rtl.myproject.autotvout_layer11_out_1.dat"
         "rtl.myproject.autotvout_layer11_out_2.dat"
         "rtl.myproject.autotvout_layer11_out_3.dat"
         "rtl.myproject.autotvout_layer11_out_4.dat"
         "rtl.myproject.autotvout_layer11_out_5.dat"
         "rtl.myproject.autotvout_layer11_out_6.dat"
         "rtl.myproject.autotvout_layer11_out_7.dat"
         "rtl.myproject.autotvout_layer11_out_8.dat"
         "rtl.myproject.autotvout_layer11_out_9.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
